...
| refdes | view | 本体中心 | 尺寸 | 来源 |
|---|---|---|---|---|
| IC12 | top | (3360, 2624) | 83×165 | rectangle r0023 (DML rot90) |
| IC11 | top | (3156, 1772) | 82×104 | rectangle r0037 (DML) |
| IC1 | bot | (2443, 2463) | 104×130 | rectangle_bot r0003 (rot90) |
| IC4 | bot | (1489, 2516) | 104×121 | rectangle_bot r0004 (rot270) |
| IC6 | bot | (1850, 1774) | 83×105 | rectangle_bot r0006 |

**教训**: 本体中心 ≠ 标签文字中心。components_index 的 center 是 OCR 标签位置,
画轮廓框必须用本体 bbox (如 IC12 标签 (3555,2719) vs 本体 (3360,2624), 差 ~200px)。
