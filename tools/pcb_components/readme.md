# tools/pcb_components — 元器件索引

`nettable/pcb_components.json` 是跨图映射的枢纽(架构见 architecture.md §1):
...
```bash
python3 pcb_components.py --project projects/IC-2200H --ai-run <某次 ai_refdes_ocr 运行JSON>
```
