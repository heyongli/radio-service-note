#!/usr/bin/env python3
"""tools/annotate_rx_flow/annotate_rx_flow.py — 块级标注工具 (旧)
purpose: 在功能块级别 (而非位号级别) 标注信号流
format: Python 3 + PIL
version: 0.2.0 (2026-09-15, 备留)
consumers: 旧的块级标注, 新流程改用 tools/annotate_svg_flow"""
