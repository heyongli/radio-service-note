...
def main():
    ...
    print(f"[pcb_label_ocr] candidates: {len(candidates)} (key={items_key}, categories={args.categories})")
    ...
    for i, r in enumerate(candidates):
        ...
        if refs:
            ...
            updated_items[rect_idx]['refdes_source'] = f"pcb_label_ocr_rot{best['rot']}_s{best['score']:.3f}"
    ...
    print(f"[pcb_label_ocr] crops_index.json updated: {args.crops_index}")
