#!/usr/bin/env python3
"""tools/circle_locator/circle_locator.py - PCB 全板圆形裁切定位器
...
def main():
    ...
    out = {
        "_meta": {
            ...
            "version": "0.1",
            "consumers": ["circle_locator/circle_locator.py", "ic_ocr_scan/ic_ocr_scan.py"],
            "tool": "tools/circle_locator/circle_locator.py",
            "tool_version": "0.1",
